...
class Celebros_Conversionpro_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	*/
    ...
    public function getJsScripts()
    {
        ...
        $html = '<script src="' . $protocol . '://' . $this->getHost() . '/uitemplate/Scripts/jquery.1.7.Celebros.min.js" type="text/javascript"></script>';
        $html .= '<script src="' . $protocol . '://' . $this->getHost() . '/uitemplate/Clients/' . $this->getSiteKey() . '/output/ClientConfig.js" type="text/javascript" ></script>';
        return $html;
    }
